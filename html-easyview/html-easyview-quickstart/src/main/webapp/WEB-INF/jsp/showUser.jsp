...
<head>
    ...
    <!-- jQuery -->
    <script type="text/javascript" src="../dependents/jquery/jquery-3.4.1.min.js"></script>
    <!-- bootstrap -->
    <script type="text/javascript" src="../dependents/bootstrap441/js/bootstrap.js"></script>
    <link type="text/css" rel="stylesheet" href="../dependents/bootstrap441/css/bootstrap.min.css">
    <!-- bootstrap-table -->
    <script type="text/javascript" src="../dependents/bootstrap441/js/bootstrap-table.js"></script>
    <script type="text/javascript" src="../dependents/bootstrap441/js/bootstrap-table-locale-all.js"></script>
    <link rel="stylesheet" type="text/css" href="../dependents/bootstrap441/css/bootstrap-table.css"/>
    <!--[if lt IE 9]>
    <script src="../dependents/htm5-ie8/html5shiv.js"></script>
    <script src="../dependents/htm5-ie8/respond.js"></script>
    <![endif]-->
    
    <!-- layui -->
    <link rel="stylesheet" type="text/css" href="../dependents/layui/css/layui.css"/>
    <script type="text/javascript" src="../dependents/layui/layui.js"></script>
    <!-- base -->
