...
public class BeanTableView extends Node<BeanTableView> {
	...
	public static BeanTableView build(TableData tableData,int toolbarStyle) {
		...
		//}
        // toobar
        ToolBar tableToolbar = ToolBar.tableToolbar(tableData.tableToolbar, tableData.btnPrefix, toolbarStyle);
