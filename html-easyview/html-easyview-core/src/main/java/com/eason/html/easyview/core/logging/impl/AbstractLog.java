...
public abstract class AbstractLog implements Log {
	...
	protected volatile boolean isFatalEnabled = true;

	protected volatile boolean isErrorEnabled = true;

	protected volatile boolean isWarnEnabled = true;

	protected volatile boolean isInfoEnabled = false;

	protected volatile boolean isDebugEnabled = false;

	protected volatile boolean isTraceEnabled = false;
	 ...
	 */
	private final LogInfo makeInfo(Object obj, Object... args) {
		if (obj == null)
			return LOGINFO_NULL;
		try {
