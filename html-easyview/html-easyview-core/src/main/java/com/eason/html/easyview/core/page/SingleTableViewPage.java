...
public class SingleTableViewPage extends BasePage {
	...
	public void build(String baseUrl, Class<?> coClass, Class<?> beanClass) {
		...
		// script
		addBodyScript(TableJsScript.of(tableData, uploadWidgetInfo, toolItemActions, customButtons,
				colMappingFormatterManager == null ? null : colMappingFormatterManager.getTableColMappingFormatters()));
	}
