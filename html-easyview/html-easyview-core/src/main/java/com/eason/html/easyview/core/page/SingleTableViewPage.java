...
public class SingleTableViewPage extends BasePage {
	...
	public void build(String baseUrl, Class<?> coClass,Class<?> beanClass) {
        ...
        // script
        addBodyScript(TableJsScript.of(tableData, customButtons, colMappingFormatterManager == null ? null
	...
	private void buildOnlineResourcesHeader() {
		...
		addHeadScript(script().setType("text/javascript")
				.setSrc("https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js"));
		...
		// bootstrap
		addLink(link().stylesheet().setType("text/css")
				.setHref("https://unpkg.com/bootstrap@3.4.1/dist/css/bootstrap.min.css"));
		addHeadScript(script().setType("text/javascript")
				.setSrc("https://unpkg.com/bootstrap@3.4.1/dist/js/bootstrap.min.js"));

		// bootstrap table
		addHeadScript(script().setType("text/javascript")
				.setSrc("https://unpkg.com/bootstrap-table@1.15.5/dist/bootstrap-table.min.js"));
		addHeadScript(script().setType("text/javascript")
				.setSrc("https://unpkg.com/bootstrap-table@1.15.5/dist/bootstrap-table-locale-all.min.js"));
		addLink(link().stylesheet().setType("text/css")
				.setHref("https://unpkg.com/bootstrap-table@1.15.5/dist/bootstrap-table.min.css"));
	...
	private void buildLocalResourcesHeader() {
		...
		// bootstrap table
		addHeadScript(
				script().setType("text/javascript").setSrc("../dependents/bootstrap-table/bootstrap-table.min.js"));
		addHeadScript(script().setType("text/javascript")
				.setSrc("../dependents/bootstrap-table/bootstrap-table-locale-all.min.js"));
		addLink(link().stylesheet().setType("text/css")
				.setHref("../dependents/bootstrap-table/bootstrap-table.min.css"));
