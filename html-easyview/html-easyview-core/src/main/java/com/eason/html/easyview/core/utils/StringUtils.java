...
public final class StringUtils {
	 ...
	 * 如果字符串为<code>null</code>，则返回<code>-1</code>。 如果字符串集合为
	 * <code>null</code>或空，也返回<code>-1</code>。
	 ...
	 * 如果字符串为<code>null</code>，则返回<code>-1</code>。 如果字符集合为
	 * <code>null</code>或空，也返回<code>-1</code>。
	 * 
	 * <pre>
	 ...
	 * @param length the size of the Integer
	 * @return int[] array
	 */
	 ...
	 * 
	 * @param strvalue String，需要转换的字符串
	...
	/**
	 * change the object <b>obj</b> which is instance of Integer(int),Long(long),
	 * Short(short) to the String <b>str</b> which is filled with zero according the
	 * <b>length</b><blockquote>
	 * 
	 * <pre>
	 * int obj = 123456;
	...
	/**
	 * 这个方法只对汉字处理，即只返回汉字拼音的第一个字母，其它的字符直接返回，示例如下： String pinyin = null; try { pinyin
	 * = mnemonicWords("你好！aa#@#￥％^&×（）……＋－＝？‘；“："); } catch (Exception ex) {
	 * ex.printStackTrace(); } 返回的结果是：nh！aa#@#￥％^&×（）……＋－＝？‘；“：
	 * 只对汉字进行了处理，其它的符号直接返回原字符串
	 * 
	 * @param strinput
	 * @return
	 * @throws Exception
	...
	/**
	 * Check String is equals. targetStr compare with compareStrArray, and return
	 * true if equals one or more
	 * 
	...
	/**
	 * <p>
	 * the value 0 if the oriStr is equal to destStr; a value less than 0 if oriStr
	 * is lexicographically less than destStr; and a value greater than 0 if oriStr
	 * is lexicographically greater than the destStr.
	 * </p>
	 * 
	 * @author DingLuoFeng 2014年10月14日 下午8:02:27
	 * @param oriStr
	 * @param destStr
	 * @return
	 */
	public static int compareTo(String oriStr, String destStr) {
		if (oriStr == null && destStr == null) {
			return 0;
		}
		if (null == (oriStr)) {
			return -1;
		...
		return oriStr.compareTo(destStr);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(compareTo(null, "123"));
		System.out.println(compareTo(null, ""));
		System.out.println(compareTo("", ""));
		System.out.println(compareTo("1.0.1", "1.0.0"));
		System.out.println(compareTo("22.010", "220.25"));
		System.out.println(compareTo("1.0.0", "1000.10"));
