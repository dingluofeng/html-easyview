...
public class TableItemActionMethodArgumentResolver extends AbstractMessageConverterMethodProcessor {
	 ...
	 */
	public TableItemActionMethodArgumentResolver(List<HttpMessageConverter<?>> converters) {
		super(converters);
	}
